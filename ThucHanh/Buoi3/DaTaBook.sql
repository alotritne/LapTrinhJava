-- =========================================================
-- File: book_database.sql
-- MySQL script tạo CSDL book theo nội dung trong hình
-- =========================================================

DROP DATABASE IF EXISTS db_ltjava;
CREATE DATABASE db_ltjava CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE db_ltjava;
...
-- =========================
-- Bảng authorISBN
-- Bảng trung gian liên kết authors và titles
-- =========================
